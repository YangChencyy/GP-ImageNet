...
#############################s#####  Train   ###########################################################
    ...
    train_set = torchvision.datasets.CIFAR100('./Datasets/CIFAR-100',
                              train=True, transform=train_transform, download=True)
    test_set = torchvision.datasets.CIFAR100('./Datasets/CIFAR-100',
    ...
    if TRAIN:
        ...
        torch.save(model.state_dict(), os.path.join(ckpt_dir, 'desnet_cifar100.pth'))
    else:
        print('######################################')
        print('Load model:')
        model_state_path = os.path.join(ckpt_dir, 'desnet_cifar100.pth')
